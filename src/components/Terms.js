      ...
      <div className='terms-main'>
        <div className='col paga  pb-1'>
           ...
           <h1 class="text-center  " >Terms And Conditions</h1>
            ...
            <h5 style={{fontWeight:"bold"}}>Intellectual Property Rights</h5>
            <ol>
            <li style={{fontWeight:"bold"}}>Ownership:</li>
            ...
            <li style={{fontWeight:"bold"}}>Usage Restrictions: </li>
            ...
            <li style={{fontWeight:"bold"}}>No License: </li>
            ...
            <h5 style={{fontWeight:"bold"}}>Disclaimer of Liability:</h5>
            <ol>
            <li style={{fontWeight:"bold"}}>Information Purpose:</li>
            ...
            <li style={{fontWeight:"bold"}}>External Links: </li>
            ...
            <li style={{fontWeight:"bold"}}>"As Is" Provision: </li>
            ...
            <h5 style={{fontWeight:"bold"}}>Jurisdiction and Governing Law:</h5>
            ...
            <h5 style={{fontWeight:"bold"}}>Compliance with Laws:</h5>
            ...
            <h5 style={{fontWeight:"bold"}}>Submission of Information</h5>
            <ol>
            <li style={{fontWeight:"bold"}}>Non-Confidentiality:</li>
           ...
           <li style={{fontWeight:"bold"}}>Unauthorized Ideas:</li>
            ...
            <h5 style={{fontWeight:"bold"}}>Modifications:</h5>
